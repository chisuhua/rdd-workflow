...
- 关联: `add-brainstorm-hardgate-enforcement` (HARD-GATE token 含 session_id)
- 关联: `add-pre-commit-proposal-quality-check` (quality check 含新字段)
- 关联: ADR-0017 rddf-session (parent_session_id 来源)
- 来源: 2026-08-27 Hybrid path reflection (本次会话)
- 文件: `skills/add-improve/scripts/{free,from_roadmap,from_issue}.sh` + `_lib/improvements/` (新)