...
if [ ! -f "$_SCRIPT_DIR/scripts/feature_summary.sh" ]; then
...
source "$_SCRIPT_DIR/scripts/feature_summary.sh"
source "$_SCRIPT_DIR/scripts/feature_graph.sh"
source "$_SCRIPT_DIR/scripts/feature_status.sh"
source "$_SCRIPT_DIR/scripts/feature_order.sh"
