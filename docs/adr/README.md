...
> ## ⚠️ 重要：v2.0 ADRs 当前为**设计草案**，未实施
>
> **2026-06-24 状态说明**：
>
> - **ADR-0001** (双阶段 spec/ship)：**当前生效**。v1.x 代码（`skills/guide-spec.md` + `skills/guide-ship.md`）按此实现。
> - **ADR-0002 ~ ADR-0008, 0010, 0011, 0012** (v2.0 架构)：**设计已采纳，但代码未实施**。
> - 实施路线图见 `docs/v2-implementation-plan.md`。
> - v2.0 实施完成后，本说明应更新。
