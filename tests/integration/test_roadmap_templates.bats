...
#
# Locks three properties of skills/roadmap/SKILL.md:
...
@test "P1-5: template 3 (blank) implemented in roadmap.md" {
  ...
  grep -qE 'TEMPLATE.*=.*"3"|TEMPLATE.*3' "skills/roadmap/SKILL.md"
}
...
@test "P1-5: template 3 (blank) uses ROADMAP_PHASE_COUNT env var" {
  ...
  grep -q "ROADMAP_PHASE_COUNT" "skills/roadmap/SKILL.md"
}
...
@test "P1-5: template 2 (Web) marked as coming soon in menu" {
  ...
  grep -qE "Web.*即将推出|Web.*coming soon" "skills/roadmap/SKILL.md"
}
