...
| [fix-skill-post-install-discoverability](.rddf/improvements/fix-skill-post-install-discoverability.md) | P1 | 2026-09-21 对话发现(roadmap-organization.md 沉淀触发) + add-spoke-system-prompt-injection 复用 | 2026-09-21 | 待审查 |
