...
**背景**: 2026-08-02 ship 复盘发现 `fix-rddf-session-owner-stability` 根因 (详见 `improvements/fix-rddf-session-owner-stability.md` 架构依据)。
...
**Goals**:
- 实施 improvements/fix-rddf-session-owner-stability.md 范围 In Scope 列出的所有项
