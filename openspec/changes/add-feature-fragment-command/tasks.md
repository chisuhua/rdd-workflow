...
- [ ] **T1** Implement `add_feature(name, phase_refs, theme, status, force, project_root)` in `_lib/roadmap_state.py`
...
- [ ] **T6** Create `skills/roadmap/scripts/roadmap_add_feature.sh`
...
- [ ] **T7** Extend `_lib/cli/roadmap_cmd.py::_SUBCOMMAND_MAP`
...
- [ ] **T8** Update `skills/guide-arch/SKILL.md`
...
- [ ] **T9** Update `skills/roadmap/SKILL.md`
...
- [ ] **T10** Add 7 unit tests in `tests/unit/test_roadmap_state.py`
...
- [ ] **T11** Add 4 bats tests in `tests/integration/test_roadmap_add_feature.bats`
...
- [ ] **T12** Update `CHANGELOG.md` v2.2+ entry noting new feature
- [ ] **T13** Update `README.md` Roadmap section linking to `add-feature` subcommand
- [ ] **T14** Update `skills/guide-design/scripts/approve_proposal.sh` (P1 bug fix)
...
- [ ] **T15** Run `./test.sh --python` and `./test.sh --bats tests/integration/test_roadmap_add_feature.bats`
      - All 11 new tests pass
      - No regression in existing 140 tests

- [ ] **T16** Run `openspec validate add-feature-fragment-command --type change --strict`
      - No errors
      - Confirms specs/design/tasks all valid

- [ ] **T17** Smoke test: `rddf roadmap add-feature smoke-test --phase-refs phase-1 --theme "smoke"`
