...
- **Fix** `docs/migration/v1-to-v2.md` — replace fictional `rdd-workflow migrate/sync/report` CLI references with real skill invocations or "planned" markers
