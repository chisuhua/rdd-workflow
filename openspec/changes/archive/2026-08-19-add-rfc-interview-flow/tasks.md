...
- [ ] 9. conventional commit: `<type>(add-rfc-interview-flow): <description>`
- [ ] 10. archive: `openspec archive add-rfc-interview-flow --yes`
- [ ] 11. cross-repo-federation spec delta 已合并 (`openspec/specs/`)
- [ ] 12. audit trail: `git log --grep='add-rfc-interview-flow'` 含清晰 commit
