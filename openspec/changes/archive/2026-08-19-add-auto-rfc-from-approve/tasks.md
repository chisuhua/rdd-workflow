# add-auto-rfc-from-approve — Tasks
...
- [ ] 9. conventional commit: `<type>(add-auto-rfc-from-approve): <description>`
- [ ] 10. archive: `openspec archive add-auto-rfc-from-approve --yes`
- [ ] 11. cross-repo-federation spec delta 已合并 (`openspec/specs/`)
- [ ] 12. audit trail: `git log --grep='add-auto-rfc-from-approve'` 含清晰 commit
