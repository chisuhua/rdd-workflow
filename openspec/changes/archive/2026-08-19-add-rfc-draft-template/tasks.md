...
- [ ] 9. conventional commit: `<type>(add-rfc-draft-template): <description>`
- [ ] 10. archive: `openspec archive add-rfc-draft-template --yes`
- [ ] 11. cross-repo-federation spec delta 已合并 (`openspec/specs/`)
- [ ] 12. audit trail: `git log --grep='add-rfc-draft-template'` 含清晰 commit
