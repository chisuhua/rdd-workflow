# Spec: skill-role-model

> Capability covering role metadata in SKILL.md frontmatter: title, perspective, ownership boundaries, and human involvement level for each phase skill.
