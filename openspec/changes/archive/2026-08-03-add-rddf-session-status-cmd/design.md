...
**背景**: 2026-08-02 ship 复盘发现 `add-rddf-session-status-cmd` 根因 (详见 `improvements/add-rddf-session-status-cmd.md` 架构依据)。
...
**Goals**:
- 实施 improvements/add-rddf-session-status-cmd.md 范围 In Scope 列出的所有项
