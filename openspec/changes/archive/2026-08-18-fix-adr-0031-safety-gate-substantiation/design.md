...
- `.rddf/improvements/fix-adr-0031-safety-gate-substantiation.md` — 完整 5 段 proposal
- `openspec/changes/fix-adr-0031-safety-gate-substantiation/proposal.md` — 落盘的完整 proposal
