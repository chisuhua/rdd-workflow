# Spec: plan-intake-bootstrap

> Capability covering plan_intake bootstrap edge cases: missing/stale design-handoff, v1↔v2 schema mixing, empty changes_pre_created, failure semantics (trace interruption, abandoned sessions), and cross-phase integration.
