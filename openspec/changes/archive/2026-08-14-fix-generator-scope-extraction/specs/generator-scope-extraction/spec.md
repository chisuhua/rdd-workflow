# Spec: generator-scope-extraction

> Capability covering `generate_full_proposal.py` scope extraction: numbered list handling, empty section fallback, and Capabilities/Impact dedup.
