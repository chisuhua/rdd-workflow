...
STATUS: PROPOSED
DATE: 2026-07-15
CHANGE: add-archive-auto-commit
RELATED: add-spec-validation-gates (post-archive dirty-tree gap observed there 2026-07-15)
RELATED_INCIDENT: add-spec-validation-gates ship flow (2026-07-15) — `openspec archive` left 5 deletions + 2 untracked dirs in working tree
---

# Capability: archive-auto-commit

> Post-`openspec archive` helper that auto-commits the file moves
> (active change dir → `archive/<date>-<name>/`, new spec → main specs/),
> eliminating the recurring dirty-working-tree gap observed in
> `add-spec-validation-gates` ship flow (2026-07-15).
>
