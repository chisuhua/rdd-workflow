...
- [x] **Task 10: improvement-check-mechanisms.md L45**
...
- [x] **Task 11: improvement-check-mechanisms.md L46, L465 (duplicate)**
...
- [x] **Task 12: improvement-check-mechanisms.md L138, L466 (duplicate)**
...
- [x] **Task 12b: improvement-check-mechanisms.md L81 (Oracle P1 catch)**
...
- [x] **Task 8b: ONBOARDING.md L105 ac-verifier dead link (Oracle P1 catch)**
...
- [x] **Task 8c: ONBOARDING.md L370 `guide-*.md` instruction (Oracle P1 catch)**
...
- [x] **Task 16: multi-project-ai-collaborative-development-gap-analysis.md L52, L63, L148 (3 lines, Oracle caught 2 misses)**
...
- [x] **Task 17: extension-points.md L13**
...
- [x] **Task 18: Extend Test 12 to all docs/architecture/*.md**
...
- [x] **Task 21: pre-patch fail verification**
...
- [x] **Task 22: Full regression gate**
  - Run: `./test.sh --full --regression`
  - Expect: no new failures
  - Test: AC-10
  - Commit: not applicable

- [x] **Task 23: AC-3 grep verification (Test 12 3-pattern with shim exclusion)**
