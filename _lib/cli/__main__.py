...
def main(argv: list[str] | None = None) -> int:
    ...
    # Some subcommands (setup, doctor) can operate outside a rdd-workflow
    # project (setup deploys to arbitrary target directories; doctor has
    # standalone categories like ai-context-bootstrap).
    _NO_STATE_CHECK = {"setup", "doctor", "help", "version"}
